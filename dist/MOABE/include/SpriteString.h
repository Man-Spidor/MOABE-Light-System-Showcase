...
public:
    ...
    /// Constructor that initializes the string with a font and a C-string.
    ///
    /// @param pFont Pointer to the font used to create the string.
    /// @param pString C-string representing the text.
    /// @param x The x-coordinate of the initial position.
    /// @param y The y-coordinate of the initial position.
    SpriteString(SpriteFont* pFont, const char* const pString, float x, float y);
    ...
    /// @param pFont Pointer to the font used to create the string.
    /// @param pString std::string representing the text.
    SpriteString(SpriteFont* pFont, const char* const pString);
